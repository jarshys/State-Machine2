	...
	public static void main(String[] args)
	{
		...
		{	
			...
			{	
				...
				//state.States();
				current = "Recovery Fail";
				System.out.println("Your current state is Recovery Fail");
...
public class Options {
	...
	public static void main(String[] args)
	{
		...
		{	
			//System.out.println("Your current state is " + current);
			System.out.println("*****The Current State of the System is " + current);
			System.out.println("What option you choose: ");
			System.out.println("1.- Anomaly");
			System.out.println("2.- Pressure");
			System.out.println("3.- Temperature");
